...
export const icons = {
  ...
  apiSkills: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="10" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/><circle cx="12" cy="16" r="1"/></svg>,
  ...
  accounts: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>,
...
export const NAV_GROUPS = [
  ...
  { id: "ceo", label: "CEO", icon: icons.star, children: [
    ...
    { id: "cash-flow", label: "Cash Flow", icon: icons.dollarSign },
    { id: "tax-center", label: "Tax Center", icon: icons.shield },
  ]},
