          ...
          <div style={{
                  ...
                  {BUSINESS_TEMPLATES.map(t => (
                    <button
                      ...
                      style={{
                        ...
                        gap: 12,
                        background: selectedTemplateId === t.id ? 'rgba(59,130,246,0.1)' : 'rgba(255,255,255,0.03)',
                        border: `1px solid ${selectedTemplateId === t.id ? 'rgba(59,130,246,0.35)' : 'rgba(255,255,255,0.07)'}`,
                        borderRadius: 10,
                        padding: '12px 14px',
                        cursor: 'pointer',
                        textAlign: 'left',
            ...
            <div style={{ display: 'flex', gap: 10, marginTop: 24 }}>
              <button
                ...
                disabled={!canSave}
                style={{
                  background: canSave ? 'rgba(59,130,246,0.18)' : 'rgba(59,130,246,0.07)',
                  border: `1px solid ${canSave ? 'rgba(59,130,246,0.4)' : 'rgba(59,130,246,0.15)'}`,
                  borderRadius: 10,
                  padding: '10px 22px',
                  fontSize: 13,
                  fontWeight: 700,
                  color: canSave ? '#3b82f6' : 'rgba(59,130,246,0.4)',
