...
// ─── Hard-coded fallback agent roster — the 30 REAL OpenClaw agents ─────────
...
export const BUILTIN_AGENTS: Agent[] = [
  ...
  { id: 'pulse',               name: 'Pulse',               description: 'Real-time health monitoring, digest synthesis',                status: 'active', capabilities: ['monitor','alert','health'],                 tier: 'utility',  trigger_type: 'cron',    health_status: 'healthy', knowledge_level: 'specialist', model: 'claude-haiku-4-5',   owner: 'Jarvis', cost_ytd: 0, created_at: '' },
  { id: 'compliance',          name: 'Compliance',          description: 'CA DRE/NMLS renewals, LLC SOI filings, license tracking',        status: 'idle',   capabilities: ['compliance','alert','document'],            tier: 'primary',  trigger_type: 'cron',    health_status: 'healthy', knowledge_level: 'expert',     model: 'claude-sonnet-4-6',  owner: 'Jarvis', cost_ytd: 0, created_at: '' },
  { id: 'legal',               name: 'Legal',               description: 'Contract review, legal strategy, entity structuring',             status: 'idle',   capabilities: ['legal','review','advise'],                  tier: 'primary',  trigger_type: 'manual',  health_status: 'healthy', knowledge_level: 'expert',     model: 'claude-sonnet-4-6',  owner: 'Jarvis', cost_ytd: 0, created_at: '' },
  { id: 'mortgage-ops',        name: 'Mortgage Ops',        description: 'Mortgage pipeline operations, loan processing, NMLS compliance',  status: 'idle',   capabilities: ['mortgage','pipeline','compliance'],         tier: 'primary',  trigger_type: 'event',   health_status: 'healthy', knowledge_level: 'expert',     model: 'claude-sonnet-4-6',  owner: 'Jarvis', cost_ytd: 0, created_at: '' },
  { id: 'realtor-ops',         name: 'Realtor Ops',         description: 'Real estate transaction ops, MLS, agent coordination',            status: 'idle',   capabilities: ['realestate','pipeline','coordinate'],       tier: 'primary',  trigger_type: 'event',   health_status: 'healthy', knowledge_level: 'expert',     model: 'claude-sonnet-4-6',  owner: 'Jarvis', cost_ytd: 0, created_at: '' },
  { id: 'health',              name: 'Health Monitor',      description: 'Fleet health watchdog, gateway + agent uptime tracking',          status: 'active', capabilities: ['monitor','alert','health'],                 tier: 'utility',  trigger_type: 'cron',    health_status: 'healthy', knowledge_level: 'specialist', model: 'claude-haiku-4-5',   owner: 'Jarvis', cost_ytd: 0, created_at: '' },
  { id: 'historian',           name: 'Historian',           description: 'Long-term memory, decision archive, pattern recognition',         status: 'idle',   capabilities: ['research','archive','synthesize'],          tier: 'utility',  trigger_type: 'cron',    health_status: 'healthy', knowledge_level: 'specialist', model: 'deepseek-reasoner',  owner: 'Jarvis', cost_ytd: 0, created_at: '' },
  { id: 'recovery',            name: 'Recovery',            description: 'Incident response, gateway recovery, system restoration',         status: 'idle',   capabilities: ['monitor','recover','alert'],                tier: 'utility',  trigger_type: 'event',   health_status: 'healthy', knowledge_level: 'specialist', model: 'claude-sonnet-4-6',  owner: 'Jarvis', cost_ytd: 0, created_at: '' },
]
