/**
 * Empire View — the macro financial dashboard. Previously "Financial Command
 * Center"; renamed per Sprint 1 (2026-04-18) per user direction. All existing
 * widgets preserved (Net Worth / Business Entities / Real Estate / Crypto /
 * QuickBooks / Flow / AI Ops / Spending / Debt / Accounts) — the Empire View
 * additions (Portfolio Donut, Entity Heat Map, Cash Flow Strip 12mo, Top
 * Revenue, Risk Flags) slot in between the hero and the detail sections.
 */
import {
  getAccounts,
...
export default async function FinancePage() {
  ...
  // Empire View additions (2026-04-18) — additive, don't replace anything.
...
`
  ...
  return (
    <>
      ...
      <Hero
        label="◆ EMPIRE VIEW · FINANCIAL COMMAND CENTER"
