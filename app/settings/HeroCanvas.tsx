  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      particles.forEach(p => {
        ...
        pg.addColorStop(0, `rgba(249,115,22,${p.alpha})`)
      ...
      drawGear(gx1, gy1, 55, 44, 12, time * 0.12, '#f9731633', 1)
      ...
      ag.addColorStop(0, 'rgba(249,115,22,0.05)'); ag.addColorStop(1, 'transparent')
